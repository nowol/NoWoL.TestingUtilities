...
#pragma warning disable CA1062 // Validate arguments of public methods
            Assert.Equal("Expecting a string or value type however received " + type.FullName,
                         ex.Message);
#pragma warning restore CA1062 // Validate arguments of public methods
        ...
        {
            var validator = ParametersValidatorHelper.GetMethodParametersValidator(new ValueTypeCreator(),
                                                                                   nameof(ValueTypeCreator.CanHandle),
                                                                                   new object[] { null });
        ...
        public void CreateDefaultValueForString()
        {
            var result = (string)_sut.Create(typeof(string),
                                             null);
            Assert.Equal(ValueTypeCreator.DefaultStringValue,
                         result);
        }
        ...
        {
            var validator = ParametersValidatorHelper.GetMethodParametersValidator(new ValueTypeCreator(),
                                                                                   nameof(ValueTypeCreator.Create),
        ...
        public void ValidateWithException()
        {
            ...
            validator.SetupParameter("paramO",
                                     ExpectedExceptionRules.NotValue(3))
                     .Validate();
        }
